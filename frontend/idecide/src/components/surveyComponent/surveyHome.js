      ...
      return (
        <div className="container" style={{ padding: "100px" }}>
          ...
          <div>
            ...
            <div className="surveyIcon">
              {localStorage.getItem("PRIORITIS") ? (
                <img
                  src={require("./iconCompleted.png")}
                  width="155px"
                  height="140px"
          ...
          localStorage.getItem("PRIORITIS") ? (
            <div>
              <MDBBtn gradient="purple">Next(To Be Done in Sprint2)</MDBBtn>
            </div>
          ) : null}
        </div>
      );
