...
const headCells = [
    ...
    { id: 'surveyId', numeric: false, disablePadding: false, label: ' SurveyId' },
	{ id: 'sectionId', numeric: true, disablePadding: false, label: 'SectionId' },
    { id: 'questions', numeric: true, disablePadding: false, label: 'QuestionsNum' },
    { id: 'completedTime', numeric: true, disablePadding: false, label: 'CompletedTime' },
	{ id: 'resultCalculation', numeric: true, disablePadding: false, label: 'ResultCalculation' },
];
								...
								.map((row, index) => {
									...
									return (
										...
										>
											...
											<TableCell align="right">{row.completedTime}</TableCell>
											<TableCell align="right">{row.resultCalculation}</TableCell>
										</TableRow>
									);
								})}
							{emptyRows > 0 && (
